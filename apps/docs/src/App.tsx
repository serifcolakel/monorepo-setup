          ...
          <Drawer.Panel canCloseWithBackDrop={false} justify="justify-end">
            ...
            <Drawer.Content>
              <div className="p-4 text-center text-blue-600 rounded-lg bg-blue-50">
                ...
                voluptate ipsa necessitatibus voluptates deserunt, mollitia
                autem earum! Explicabo nihil officiis ipsum, aut tenetur,
                nesciunt dolores hic laudantium quaerat reiciendis ratione quia.
                Doloribus praesentium veritatis qui vero?
              </div>
              <DrawerCustomClose />
            </Drawer.Content>
          </Drawer.Panel>
          ...
          <Drawer.Panel canCloseWithBackDrop={false} justify="justify-end">
            <Drawer.Header className="border-b border-b-gray-50">
              ...
              <Drawer.Description>
                ...
                qui deserunt, hic error unde alias.
              </Drawer.Description>
            </Drawer.Header>
            <Drawer.Content>
